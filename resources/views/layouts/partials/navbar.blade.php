<nav class="navbar navbar-main navbar-expand-lg px-0 mx-3 mt-3 border-radius-xl" style="background-color: white;" data-scroll="true">
    <div class="container-fluid py-1 px-3">
        <div class="d-flex justify-content-between w-100">
            <nav aria-label="breadcrumb d-min-md-none">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Pages</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">index</li>
                </ol>
            </nav>
            <ul class="navbar-nav ms-auto"> <!-- ms-auto untuk meletakkan di sebelah kanan -->
                ...
                <li class="nav-item d-xl-none ps-3 d-flex align-items-center mr-3"> <!-- mr-3 untuk memberikan jarak -->
